function cargar(Inicio) {
    if (Inicio != undefined && Inicio != null && Inicio != "") {
        ...
        var sitio_base = "https://coincoinx.com";
        ...
        var div_cuerpo_right = document.createElement("div");
        div_cuerpo_right.id = "cuerpo_widget_coincoinx_right";

        var div_horizontal0 = document.createElement("div");
        var div_horizontal1 = document.createElement("div");
        var div_horizontal11 = document.createElement("div");
        var div_horizontal21 = document.createElement("div");
        ...
        var div_horizontal51 = document.createElement("div");
        var div_horizontal6 = document.createElement("div");
        var div_horizontal61 = document.createElement("div");
        ...
        div_horizontal0.innerHTML = "<label class='ccx-bottom-10 control-label-coincoinx w100p-coincoinx center-ccx '><h1c>" + monto + " " + moneda + "</h1c></label>";

        div_cuerpo.appendChild(div_horizontal0);

        var label_1 = document.createElement("label");
        label_1.className = "control-label-coincoinx2";
        label_1.innerHTML = (lang == "EN") ? "Description " : "Descripciónn ";
        ...
        div_horizontal11.appendChild(label_1);
        div_horizontal1.appendChild(input_1);

        div_cuerpo.appendChild(div_horizontal11);
        div_cuerpo.appendChild(div_horizontal1);

        var label_2s = document.createElement("label");
        label_2s.className = "control-label-coincoinx2";
        ...
        input_2s.addEventListener("click", function () {
            ...
            qr.src = "https://chart.googleapis.com/chart?chs=400x400&cht=qr&chl=" + first_address;

            qr.setAttribute("src", "https://chart.googleapis.com/chart?chs=400x400&cht=qr&chl=" + first_address);
            ...
            qr2.src = "https://chart.googleapis.com/chart?chs=400x400&cht=qr&chl=" + sitio_base + "/Gateway/?s=" + btoa(datccxapp);
        ...
        div_horizontal21.appendChild(label_2s);

        div_horizontal2s.appendChild(input_2s);

        div_cuerpo.appendChild(div_horizontal21);
        ...
        div_cuerpo.appendChild(document.createElement("hr"));
        ...
        label_5.className = "control-label-coincoinx2";
        ...
        input_5.readOnly = 1;
        input_5.setAttribute("placeholder", (lang == "EN") ? "Payment Address " : "DirecciÃ³n del Pago");
        ...
        div_horizontal51.appendChild(label_5);
        ...
        label_6.className = "control-label-coincoinx2";
        ...
        div_horizontal61.appendChild(label_6);
        ...
        div_cuerpo_right.appendChild(div_tabcGeneral);

        div_cuerpo_right.appendChild(div_horizontal51);
        div_cuerpo_right.appendChild(div_horizontal5);

        div_cuerpo_right.appendChild(div_horizontal61);
        div_cuerpo_right.appendChild(div_horizontal6);
                                        ...
                                        if (data5.status == 0) {
                                            if (lang == "EN") {
                                                ...
                                                div_tabcGeneral.innerHTML = '<div id="modal-cobra-pay"  class=""  aria-hidden="true">' +
                                                    ...
                                                    '   <div class="coincoinx-header-noti">' +
                                                    '   <i class="glyphicon glyphicon-check"></i>' +
                                                    '   PRIMERA CONFIRMACIÃ“N DEL PAGO' +
                                                    '</div>' +
                                                    '<div class="modal-body"><div class="check_mark">' +
                                                    '   <div id="success_coincoinx" class="sa-icon sa-success hide animate">' +
                                                    '   <span class="sa-line sa-tip animateSuccessTip"></span>' +
                                                    ...
                                                    '   </div></div>' +
                                                    '    <div id = "title-pay-ccx" class="modal-title">' +
                                                    '   Se obtuvo la primera confirmaciÃ³n del pago' +
                                                    '</div>' +
                                                    '<div class="coincoinx-footer-noti">' +
                                                    '    </div></div></div></div>';
                                            }
        ...
        div_contenedor.appendChild(div_cuerpo_right);
        div_contenedor.appendChild(div_cls);
        div_contenedor.appendChild(div_horizontal8);
        ...
        if (monto <= 0 || monto == "") {
            ...
            if (idorden <= 0 || idorden == "") {
                div_encabezado_text = (lang == "EN") ? "Incorrect Order Number, must be greater than 0" : "NÃºmero de Orden Incorrecto, debe ser mayor a 0";
            } else {
                if (idwidget == "") {
